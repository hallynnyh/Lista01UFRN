...
*p1 = 20; // Armazena o valor 20 dentro do espaço de memória endereçado por 'p1', mesmo espaço de memória alocada para a variável 'valor'. Portanto, o resultado armazenado na variável 'valor' foi alterado.
...
*p2 = 29.0;	// Armazena o valor 29.0 dentro do espaço de memória endereçado por 'p2', mesmo espaço de memória alocada para a variável 'temp'. Logo, o resultado armazenado na variável 'temp' foi alterado.
...
aux = *p3; // Variável aux recebe o conteúdo do ponteiro 'p3'.
printf("%c \n", aux);	// Imprime o valor guardado em 'aux'.

// Resultado: e

/* (e) */
p3 = nome; // Armazena o endereço do vetor 'nome' no ponteiro p3. Como não foi especificado a posição do vetor, o ponteiro 'p3' irá armazenar a posição '0' do vetor 'nome'.
printf("%c \n", *p3);	// Imprime o valor apontado por 'p3'.

// Resultado: P

/* (f) */
p3 = p3 + 4; // O endereço do ponteiro 'p3' irá se deslocar 4 bytes para frente, já que o ponteiro 'p3' é do tipo char (1 byte).
printf("%c \n", *p3);	// Imprime o valor apontado por 'p3'.

// Resultado: e

/* (g) */
p3--; // O endereço do ponteiro 'p3' irá se deslocar em 1 byte para trás, já que o ponteiro 'p3' é do tipo char (1 bype).	
printf("%c \n", *p3);	// Imprime o valor apontado por 'p3'.
...
p4 = vetor; // O ponteiro 'p4' recebe o endereço do vetor 'vetor'. Como 'p4' só guarda um endereço, então o endereço guardado no ponteiro será o endereço da posição '0' do vetor 'vetor'.
